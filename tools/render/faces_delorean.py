...
def face_delorean(c, hh, mm, ss, mday, mon, year, wday, temp_f, sunrise, sunset):
    ...
    well(65, 108, 34, 24)
    digits("%02d" % hh, 68, 111, 13, 18, 3, 3, RED, RED_OFF)
    well(103, 108, 34, 24)
    digits("%02d" % mm, 106, 111, 13, 18, 3, 3, RED, RED_OFF)
    well(141, 108, 34, 24)
    digits("%02d" % ss, 144, 111, 13, 18, 3, 3, RED, RED_OFF)
    ...
    well(159, 150, 52, 24)
    digits("%04d" % year, 162, 153, 11, 18, 3, 2, GRN, GRN_OFF)
